...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>Library System For Trinitas College</title>
...
<body class="bg-dark" style="background: url(libraryimg.jpg) no-repeat;  background-size:cover">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <img src="logo.jpg" alt="Logo" style="width: 100px; height: auto;">
       ...
       <h2><center style="color:green;">Library System For Trinitas College Admins</center></h2>
      </div>
      <div class="card-body">
